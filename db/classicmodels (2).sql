...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2016 at 06:43 AM
...
(2, 'Umesh Chaurasiya', 'chaurasiyaumesh9@gmail.com', '8407907092'),
(3, 'Umesh Chaurasiya', 'umesh.chaurasiya@adapty.com', '8407907092'),
(4, 'manoj yadav', 'manoj.yadav@adapty.com', '12345'),
(5, 'soham ffgfdgf', 'soham@adapty.com', '546456332'),
(6, 'PK', 'PK@songspk.com', '212321321321'),
(7, 'vinit', 'vinit@adapty.com', '3243242 23432'),
(8, 'priyanka', 'priyanka@adapty.com', '23243243'),
...
INSERT INTO `payers` (`p_Id`, `e_Id`, `m_Id`, `p_amount`) VALUES
(1, 1, 2, 200),
(2, 1, 3, 400),
(3, 1, 6, 150),
(4, 2, 1, 600),
...
--
ALTER TABLE `payers`
  ADD CONSTRAINT `payers_ibfk_1` FOREIGN KEY (`e_Id`) REFERENCES `events` (`e_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `payers_ibfk_2` FOREIGN KEY (`m_Id`) REFERENCES `members` (`m_Id`) ON DELETE CASCADE ON UPDATE CASCADE;
